		...
		<footer className="text-white text-center sm:text-left bg-color-dark">
			<div className="max-w-5xl mx-auto pb-10 pt-10 text-gray-900">
				<ul>
						...
						<li className="inline-block"><a className="block font-semibold px-3 h-12" href="#/tron/smartwallet">Smartwallet</a></li>
						{/* <li className="inline-block"><a className="block font-semibold px-3 h-12" href="/#/claim">Claim</a></li> */}
				</ul>
				<div className="sm:flex px-3">
						<div className="w-full sm:w-1/2">
								<div>
									{/* <img src="/img/isotipo.png" alt="droptracker logo" className="h-12 mx-auto md:-ml-4" /> */}
									<span className="block text-lg font-light font-bold h-30 page-title">Dazzle Protocol</span>
